...
Um ponto de atenção é sobre os intervalos de confiança, obtidos por meio bootstrap, é o fato de que a técnica assume que os dados amostrados são independentes e identicamente distribuídos (i.i.d.). Diante da natureza dos dados de série temporal, essa premissa pode não ser totalmente satisfeita, já que em uma análise nos resíduos de time bars \autoref{fig:acf_time_bars} e dollar bars \autoref{fig:acf_dollar_bars} podemos observar indícios de autocorrelação. 